...
def crossover(parent1: Individual, parent2: Individual, with_pair=True) -> Tuple[Individual, Individual]:
    ...
    if with_pair:
        ...
        return Ind(child1_genes, child1_pairs, parent1.param_types), Ind(child2_genes, child2_pairs, parent2.param_types)
    else:
        from individual import Individual as Ind
        return Ind(child1_genes, parent1.trading_pairs, parent1.param_types), Ind(child2_genes, parent2.trading_pairs, parent2.param_types)
