"""Oil Money NOK: Statistical arbitrage on Norwegian Krone and Brent crude using regression-based mean reversion.
Note: Model validity requires recalibration when market conditions change."""
